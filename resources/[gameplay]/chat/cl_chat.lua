...
local KDCore = exports['kd-core']:GetCoreObject()
local chatLoaded, chatHidden = false, true

RegisterNetEvent('KDCore:Client:OnPlayerLoaded')
AddEventHandler('KDCore:Client:OnPlayerLoaded', function()
    Citizen.SetTimeout(1000, function()
        LoggedIn = true
    end)
end)

RegisterNetEvent('KDCore:Client:OnPlayerUnload')
AddEventHandler('KDCore:Client:OnPlayerUnload', function()
    LoggedIn = false
end)
